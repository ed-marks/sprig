...
func mergeWithEmptyValues(dst map[string]interface{}, srcs ...map[string]interface{}) interface{} {
	for _, src := range srcs {
...
func mustMergeWithEmptyValues(dst map[string]interface{}, srcs ...map[string]interface{}) (interface{}, error) {
	for _, src := range srcs {
		  if err := mergo.Merge(&dst, src, mergo.WithOverwriteWithEmptyValue); err != nil {
			return nil, err
		  }
